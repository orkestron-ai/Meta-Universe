...
```bash
# fingerprints round-trip (mu-fingerprint, see ../../tools/)
mu-fingerprint acme/employee-mm.muif.json   # sha256:0b4965f1...
mu-fingerprint gov/taxpayer-mm.muif.json    # sha256:d51f639e...
